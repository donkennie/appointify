  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-5 sm:flex-row items-start mt-5'>
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-[var(--primary)] text-white' : ''}`} onClick={() => setShowFilter(prev => !prev)}>Filters</button>
