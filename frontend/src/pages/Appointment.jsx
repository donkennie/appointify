  ...
  return docInfo && (
    <div>
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='[var(--primary)] w-full sm:max-w-72 rounded-lg' src={docInfo.image} alt="" />
        </div>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex items-center gap-2 text-sm mt-1 text-gray-600'>
            <p>
              {docInfo.degree} - {docInfo.specialify}
            </p>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
          ...
          <button className='bg-[var(--primary)] text-white text-sm font-light px-14 py-3 rounded-full my-6'>
            Book an appointment
          </button>
      </div>
